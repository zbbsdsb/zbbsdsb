...
```yaml
👤 Name: Ceaser Zhao
📍 Location: Sichuan, Mainland China
🎓 Education: High School Student
🎯 Focus: Computer Graphics · Full-Stack · Blockchain · VEX Robotics
✨ Dream: Be a dreamer
🗣️ Languages: 中文, English, Español, हिन्दी, Deutsch, العربية
🧠 Philosophy: Break 2 Make
❤️ My Luv: Metaverse, UE and ASALKA!!
📜 Motto: Let's build the Oasisverse from here
```
...
- 🧠 Machine Learning
- ⛓️ Web 3.0
- 📐 Mathematics, Physics, Linguistics, Economics, Philosophy...
...
#### 🎨 MuseRock
AI collaboration tools, an endless source of inspiration for creators.
![Stars](https://img.shields.io/github/stars/zbbsdsb/MuseRock?style=flat-square)
![TypeScript](https://img.shields.io/badge/TypeScript-007ACC?style=flat-square)
*Copyright Oasis Company*
...
![Stars](https://img.shields.io/github/stars/zbbsdsb/OasisBio-Ecosystem?style=flat-square)
![License](https://img.shields.io/github/license/zbbsdsb/OasisBio-Ecosystem?style=flat-square)
...
![Stars](https://img.shields.io/github/stars/zbbsdsb/R-U-Socrates?style=flat-square)
![Forks](https://img.shields.io/github/forks/zbbsdsb/R-U-Socrates?style=flat-square)
...
#### 🤖 QueueDesk
AI-powered internal service desk for teams — auto-routes, prioritizes, and resolves support tickets.
![Stars](https://img.shields.io/github/stars/zbbsdsb/QueueDesk?style=flat-square)
![License](https://img.shields.io/github/license/zbbsdsb/QueueDesk?style=flat-square)
...
#### 📚 Thoth
made by ceaserzhao
![Stars](https://img.shields.io/github/stars/zbbsdsb/Thoth?style=flat-square)
![License](https://img.shields.io/github/license/zbbsdsb/Thoth?style=flat-square)
![TypeScript](https://img.shields.io/badge/TypeScript-007ACC?style=flat-square)
...
*(10 stars)*
u will know later
![Stars](https://img.shields.io/github/stars/zbbsdsb/Urconomy?style=flat-square)
![Forks](https://img.shields.io/github/forks/zbbsdsb/Urconomy?style=flat-square)
![License](https://img.shields.io/github/license/zbbsdsb/Urconomy?style=flat-square)
...
![Stars](https://img.shields.io/github/stars/zbbsdsb/cebu?style=flat-square)
![Forks](https://img.shields.io/github/forks/zbbsdsb/cebu?style=flat-square)
![License](https://img.shields.io/github/license/zbbsdsb/cebu?style=flat-square)

</td>
<td width="33%" valign="top">

#### 🎨 ame-ui
UI lib for AMAR ENGINE
![Stars](https://img.shields.io/github/stars/zbbsdsb/ame-ui?style=flat-square)
![TypeScript](https://img.shields.io/badge/TypeScript-007ACC?style=flat-square)
...
#### 💫 echo
A chaos-driven, VR-native protocol for exploring your inner cosmos.
![Stars](https://img.shields.io/github/stars/zbbsdsb/echo?style=flat-square)
![License](https://img.shields.io/github/license/zbbsdsb/echo?style=flat-square)

</td>
</tr>
</table>

### 🏛️ Oasis Company Projects
...
![Stars](https://img.shields.io/github/stars/Oasis-Company/Biosurf?style=flat-square)
![Forks](https://img.shields.io/github/forks/Oasis-Company/Biosurf?style=flat-square)
...
![Stars](https://img.shields.io/github/stars/Oasis-Company/metaclass-prototype?style=flat-square)
...
### 📱 Applications
- [HeyaLab](https://github.com/zbbsdsb/HeyaLab) - going to make heyacore
...
### 🚀 Infrastructure
- [arnis](https://github.com/zbbsdsb/arnis) - Generate any location from the real world in Minecraft with high level of detail
- [Oasis-Ecosystem](https://github.com/zbbsdsb/Oasis-Ecosystem) - OasisBio For EveryOne!
...
|------|------|-------------|
| 🏝️ | **[Oasis Company](https://github.com/oasiscompany)** | Created at age 11 in school with the dream of building an unprecedented metaverse. |
| 😂 | **[3idiotz](https://github.com/3idiotz)** | A team with two Indian brothers, named after the Bollywood movie *3 Idiots*. |
| 🎨 | **[MYSHCGclub](https://github.com/MYSHCGclub)** | Mianyang High School Computer Graphics Club - focused on physics engine development. |
| ✨ | **[OasisFrontEndStudio](https://github.com/OasisFrontEndStudio)** | Specializes in front-end animations and chaotic system demonstrations. |
| 📡 | **[Oermos](https://github.com/Oermos)** | Communication systems for the Oasis ecosystem. |
| 🏫 | **[Mianyang Highschool](https://github.com/MianyangHighschool)** | Umbrella organization for clubs at my high school. |
| 📱 | **[OasisAndroidApp](https://github.com/OasisAndroidApp)** | Open-source Android applications. |
...
### 🔗 Other Accounts
- [ceaserandrew](https://github.com/ceaserandrew)
- [QolarBearFR](https://github.com/QolarBearFR)
...
<img src="https://komarev.com/seal/year=2025,style=flat-square,color=00C8FF/github/zbbsdsb" alt="Visitors" />
